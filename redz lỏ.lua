...
-- 🧩 BUTTON
TabServer:AddButton({
    Name = "Nhận Sv Vip Đéo Có Hoạt Động",
    Callback = function()
        -- Chưa có chức năng
    end
})
...
-- 🧩 TOGGLE
TabStats:AddToggle({
    Name = "Đéo Hoạt Động Nói Lắm Thế",
    Default = false,
    Callback = function(Value)
        -- Chưa có chức năng
    end
...
--⚠️ Nút Super Fast Attack
 TabSettings:AddToggle({
 	Name = "Super Fast Attack⚠️
     Default = false,
     Callback = function(Value)
               --Chưa có chức năng
        end
